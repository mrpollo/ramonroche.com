...
class wpTwitterWidget extends XavisysPlugin {
	...
	public function display( $args ) {
		...
		$widgetContent .= '<div class="side-heading"><a href="http://twitter.com/mrpollo" class="twitter-follow-button" data-button="grey" data-text-color="#FFFFFF" data-link-color="#00AEFF">Follow @mrpollo</a><script src="http://platform.twitter.com/widgets.js" type="text/javascript"></script></div>';
