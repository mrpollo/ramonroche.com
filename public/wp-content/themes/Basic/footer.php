...
<div id="footer">
	&copy; <?php bloginfo('name'); _e(' '.date('Y').'. All rights reserved. ','Basic'); ?> <?php _e('Powered by ','Basic'); ?> <a href="http://www.wordpress.org">Wordpress</a> | Design By <a href="http://tikafender.com/"> Tika Fender </a> | <?php _e('Layout by ','Basic'); ?> <a href="http://www.elegantthemes.com">Elegant Themes</a>
</div>
<?php
