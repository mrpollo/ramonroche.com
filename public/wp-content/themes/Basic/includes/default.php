...
<div>
    ...
    <a href="<?php the_permalink() ?>" rel="bookmark" class="readmore" title="<?php printf(__('Permanent Link to %s','Basic'), get_the_title()) ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/readmore.gif" alt="read more" style="border: none;" /></a> </div>
<?php endwhile; ?>
<div style="clear: both;"></div>
