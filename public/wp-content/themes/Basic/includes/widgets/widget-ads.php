...
<?php if ($bannerTitle[$i] == '') $bannerTitle[$i] = "advertisement";
	...
	<a href="<?php echo $bannerUrl[$i] ?>" <?php if ($new_window == 1) echo('target="_blank"') ?>><img src="<?php if ($use_relpath == 1) bloginfo('url'); else echo $bannerPath[$i]; ?><?php if ($use_relpath == 1 ) echo ("/" . $bannerPath[$i]); ?>" alt="<?php echo $bannerAlt[$i]; ?>" title="<?php echo $bannerTitle[$i]; ?>" style="border: none;" /></a>
<?php }; $i++;
endwhile; ?>
</div> <!-- end adwrap -->
<?php
